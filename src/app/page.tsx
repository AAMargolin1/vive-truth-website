        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {argumentCards.map((card) => (
              <Link key={card.pageId} href={`/${card.pageId}`} passHref legacyBehavior>
                <a className="card p-8 rounded-lg flex flex-col bg-gray-900/70 backdrop-blur-md border border-gray-700/50 hover:border-accent-gold/70 hover:shadow-accent-gold/30 hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
          ...
          <div className="mt-12 flex justify-center">
            <Link href={`/${bonusCard.pageId}`} passHref legacyBehavior>
               <a className="card p-8 rounded-lg w-full lg:w-2/3 flex flex-col md:flex-row items-center bg-gray-900/70 backdrop-blur-md border border-gray-700/50 hover:border-accent-gold/70 hover:shadow-accent-gold/30 hover:shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
